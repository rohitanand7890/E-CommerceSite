...
-- CREATE TABLE IF NOT EXISTS orders (id CHAR(8) NOT NULL PRIMARY KEY, item_id CHAR(8) NOT NULL, user_id CHAR(8) NOT NULL, quantity INTEGER, amount INTEGER, FOREIGN KEY (item_id) REFERENCES items(id), FOREIGN KEY (user_id) REFERENCES users(id));
